...
namespace Avalonia.Base.UnitTests
{
    public class AvaloniaObjectTests_Validation
    {
        ...
        [Fact]
        public void LocalValue_Binding_Reverts_To_DefaultValue_If_Validation_Fails()
        {
            var target = new Class1();
        ...
        [Fact]
        public void LocalValue_Binding_Reverts_To_DefaultValue_If_Validation_Fails_Even_In_Presence_Of_Other_Bindings()
        {
            var target = new Class1();
        ...
        [Fact]
        public void StyleTrigger_Binding_Reverts_To_DefaultValue_If_Validation_Fails()
        {
            var target = new Class1();
            var source = new Subject<int>();
